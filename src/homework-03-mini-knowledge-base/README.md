...
**3 種問法全部命中預期城市，且第 1 名與第 2 名之間有明顯分數差距。** 查詢 2 的差距最大（0.464 對 0.291，相差 0.173），查詢 1 次之（0.506 對 0.360，相差 0.146），查詢 3 為 0.443 對 0.346（相差 0.097）。三題的第一名都領先第二名約 0.10～0.17，代表排序並非勉強勝出，語意檢索確實抓到了正確的知識條目。
...
另外可觀察到花蓮在三題中都排進前 3 名，這是因為知識庫僅 5 筆、且花蓮的描述涵蓋「自然、觀光、好山好水」等泛用性較高的詞彙，容易與各種旅遊類問句產生中等程度的相關性。其分數（0.291～0.349）明顯低於各題第一名，排序上並未造成干擾。
